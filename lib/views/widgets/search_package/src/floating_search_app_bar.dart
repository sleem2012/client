...
class FloatingSearchAppBarState extends ImplicitlyAnimatedWidgetState<FloatingSearchAppBarStyle, FloatingSearchAppBar> {
  ...
  List<Widget> get actions {
    ...
    final showHamburger = widget.automaticallyImplyDrawerHamburger && Scaffold.of(context).hasEndDrawer;
  ...
  List<Widget> get leadingActions {
    ...
    final showHamburger = widget.automaticallyImplyDrawerHamburger && Scaffold.of(context).hasDrawer;
  ...
  Widget _buildAppBar() {
    ...
    final brightness = widget.brightness ?? (backgroundColor.computeLuminance() > 0.7 ? Brightness.light : Brightness.dark);
      ...
      if (widget.title != null) {
        ...
        if (isAppBar) {
          input = DefaultTextStyle(
            ...
            style: Theme.of(context).appBarTheme.toolbarTextStyle ?? Theme.of(context).textTheme.headline6 ?? const TextStyle(),
            child: input,
          );
        }
      } else {
        ...
        final textStyle = hasQuery ? style.queryStyle ?? textTheme.subtitle1 : style.hintStyle ?? textTheme.subtitle1?.copyWith(color: theme.hintColor);
...
class _FloatingSearchProgressBarState extends State<_FloatingSearchProgressBar> with SingleTickerProviderStateMixin {
  ...
  void didUpdateWidget(_FloatingSearchProgressBar oldWidget) {
    ...
    final show = progress != null && (progress is num || (progress is bool && progress == true));
