...
mixin _$SearchState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<UserCompany>? data) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<UserCompany>? data)? success,
...
abstract class _$$SearchStateSuccessCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<UserCompany>? data});
}
...
class _$SearchStateSuccess implements SearchStateSuccess {
  const _$SearchStateSuccess({required final List<UserCompany>? data})
      : _data = data;

  final List<UserCompany>? _data;
  @override
  List<UserCompany>? get data {
    final value = _data;
...
abstract class SearchStateSuccess implements SearchState {
  const factory SearchStateSuccess({required final List<UserCompany>? data}) =
