...
class CompanyBranch {
  ...
  factory CompanyBranch.fromJson(Map<String, dynamic> map) {
    return CompanyBranch(
      company: map['company'] != null ? UserCompany.fromJson(map['company'] as Map<String, dynamic>) : null,
      id: map['id'],
      address: map['address'] != null ? Address.fromJson(map['address'] as Map<String, dynamic>) : null,
    );
  }
